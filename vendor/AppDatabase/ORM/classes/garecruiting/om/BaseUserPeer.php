...
use GARecruitingORM\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'GARecruitingORM\\User';
    ...
    /** the column name for the EXPIRATION_TIME field */
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UserId', 'EmailAddress', 'Password', 'AuthenticationToken', 'ExpirationTime', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'emailAddress', 'password', 'authenticationToken', 'expirationTime', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID, UserPeer::EMAIL_ADDRESS, UserPeer::PASSWORD, UserPeer::AUTHENTICATION_TOKEN, UserPeer::EXPIRATION_TIME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'EMAIL_ADDRESS', 'PASSWORD', 'AUTHENTICATION_TOKEN', 'EXPIRATION_TIME', ),
        BasePeer::TYPE_FIELDNAME => array ('user_id', 'email_address', 'password', 'authentication_token', 'expiration_time', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'EmailAddress' => 1, 'Password' => 2, 'AuthenticationToken' => 3, 'ExpirationTime' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'emailAddress' => 1, 'password' => 2, 'authenticationToken' => 3, 'expirationTime' => 4, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID => 0, UserPeer::EMAIL_ADDRESS => 1, UserPeer::PASSWORD => 2, UserPeer::AUTHENTICATION_TOKEN => 3, UserPeer::EXPIRATION_TIME => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'EMAIL_ADDRESS' => 1, 'PASSWORD' => 2, 'AUTHENTICATION_TOKEN' => 3, 'EXPIRATION_TIME' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'email_address' => 1, 'password' => 2, 'authentication_token' => 3, 'expiration_time' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::EMAIL_ADDRESS);
            $criteria->addSelectColumn(UserPeer::PASSWORD);
            $criteria->addSelectColumn(UserPeer::AUTHENTICATION_TOKEN);
            $criteria->addSelectColumn(UserPeer::EXPIRATION_TIME);
        } else {
            $criteria->addSelectColumn($alias . '.USER_ID');
            $criteria->addSelectColumn($alias . '.EMAIL_ADDRESS');
            $criteria->addSelectColumn($alias . '.PASSWORD');
            $criteria->addSelectColumn($alias . '.AUTHENTICATION_TOKEN');
            $criteria->addSelectColumn($alias . '.EXPIRATION_TIME');
        }
    }
    ...
    {
        // Invalidate objects in ApplicantPeer instance pool,
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related Applicant objects
            $criteria = new Criteria(ApplicantPeer::DATABASE_NAME);

            $criteria->add(ApplicantPeer::USER_ID, $obj->getUserId());
            $affectedRows += ApplicantPeer::doDelete($criteria, $con);
        }
