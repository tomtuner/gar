...
/**
 * Base class that represents a row from the 'notification_group' table.
 *
 *
 *
 * @package    propel.generator.garecruiting.om
 */
abstract class BaseNotificationGroup extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'GARecruitingORM\\NotificationGroupPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NotificationGroupPeer
     */
    ...
    /**
     * The value for the notification_group_name field.
     * @var        string
     */
    protected $notification_group_name;
    ...
    /**
     * Get the [notification_group_name] column value.
     *
     * @return string
     */
    public function getNotificationGroupName()
    {
        return $this->notification_group_name;
    }
     ...
     * @return NotificationGroup The current object (for fluent API support)
     */
    public function setNotificationGroupId($v)
    {
        ...
        if ($this->notification_group_id !== $v) {
            ...
            $this->modifiedColumns[] = NotificationGroupPeer::NOTIFICATION_GROUP_ID;
        }
    ...
    /**
     * Set the value of [notification_group_name] column.
     *
     * @param string $v new value
     * @return NotificationGroup The current object (for fluent API support)
     */
    public function setNotificationGroupName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->notification_group_name !== $v) {
            $this->notification_group_name = $v;
            $this->modifiedColumns[] = NotificationGroupPeer::NOTIFICATION_GROUP_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->notification_group_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = NotificationGroupPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NotificationGroup object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NotificationGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NotificationGroupQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NotificationGroupPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = NotificationGroupPeer::NOTIFICATION_GROUP_ID;
        if (null !== $this->notification_group_id) {
        ...
        if ($this->isColumnModified(NotificationGroupPeer::NOTIFICATION_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`NOTIFICATION_GROUP_ID`';
        }
        if ($this->isColumnModified(NotificationGroupPeer::NOTIFICATION_GROUP_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NOTIFICATION_GROUP_NAME`';
        }

        $sql = sprintf(
            'INSERT INTO `notification_group` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`NOTIFICATION_GROUP_ID`':
                        ...
                        break;
                    case '`NOTIFICATION_GROUP_NAME`':
                        $stmt->bindValue($identifier, $this->notification_group_name, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
        ...
        $this->setNotificationGroupId($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NotificationGroupPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NotificationGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getNotificationGroupName();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['NotificationGroup'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NotificationGroup'][$this->getPrimaryKey()] = true;
        $keys = NotificationGroupPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getNotificationGroupId(),
            $keys[1] => $this->getNotificationGroupName(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setNotificationGroupName($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNotificationGroupName($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotificationGroupPeer::NOTIFICATION_GROUP_ID)) $criteria->add(NotificationGroupPeer::NOTIFICATION_GROUP_ID, $this->notification_group_id);
        if ($this->isColumnModified(NotificationGroupPeer::NOTIFICATION_GROUP_NAME)) $criteria->add(NotificationGroupPeer::NOTIFICATION_GROUP_NAME, $this->notification_group_name);
    ...
    {
        $criteria = new Criteria(NotificationGroupPeer::DATABASE_NAME);
        $criteria->add(NotificationGroupPeer::NOTIFICATION_GROUP_ID, $this->notification_group_id);
    ...
    /**
     * Generic method to set the primary key (notification_group_id column).
     *
    ...
    {
        $this->setNotificationGroupId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getNotificationGroupId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of NotificationGroup (or compatible) type.
    ...
    {
        $copyObj->setNotificationGroupName($this->getNotificationGroupName());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setNotificationGroupId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NotificationGroup Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NotificationGroupPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NotificationGroupPeer();
        }
     ...
     * If this NotificationGroup is new, it will return
        ...
        if (null === $this->collNotifeeNotificationGroups || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collNotifeeNotificationGroups) {
                ...
                $collNotifeeNotificationGroups = NotifeeNotificationGroupQuery::create(null, $criteria)
                    ->filterByNotificationGroup($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setNotifeeNotificationGroups(PropelCollection $notifeeNotificationGroups, PropelPDO $con = null)
    {
        ...
        foreach ($this->notifeeNotificationGroupsScheduledForDeletion as $notifeeNotificationGroupRemoved) {
            $notifeeNotificationGroupRemoved->setNotificationGroup(null);
        }
    ...
    protected function doAddNotifeeNotificationGroup($notifeeNotificationGroup)
    {
        ...
        $notifeeNotificationGroup->setNotificationGroup($this);
    }
    ...
    public function removeNotifeeNotificationGroup($notifeeNotificationGroup)
    {
        if ($this->getNotifeeNotificationGroups()->contains($notifeeNotificationGroup)) {
            ...
            $notifeeNotificationGroup->setNotificationGroup(null);
        }
    }
     ...
     * Otherwise if this NotificationGroup is new, it will return
     * an empty collection; or if this NotificationGroup has previously
     * been saved, it will retrieve related NotifeeNotificationGroups from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in NotificationGroup.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|NotifeeNotificationGroup[] List of NotifeeNotificationGroup objects
     */
    public function getNotifeeNotificationGroupsJoinNotifiee($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = NotifeeNotificationGroupQuery::create(null, $criteria);
        $query->joinWith('Notifiee', $join_behavior);
    ...
    public function setPositionNotificationGroups(PropelCollection $positionNotificationGroups, PropelPDO $con = null)
    {
        ...
        foreach ($this->positionNotificationGroupsScheduledForDeletion as $positionNotificationGroupRemoved) {
            $positionNotificationGroupRemoved->setNotificationGroup(null);
        }
    ...
    protected function doAddPositionNotificationGroup($positionNotificationGroup)
    {
        ...
        $positionNotificationGroup->setNotificationGroup($this);
    }
    ...
    public function removePositionNotificationGroup($positionNotificationGroup)
    {
        if ($this->getPositionNotificationGroups()->contains($positionNotificationGroup)) {
            ...
            $positionNotificationGroup->setNotificationGroup(null);
        }
    }
     ...
     * @return PropelObjectCollection|PositionNotificationGroup[] List of PositionNotificationGroup objects
     */
    public function getPositionNotificationGroupsJoinPosition($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PositionNotificationGroupQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->notification_group_name = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(NotificationGroupPeer::DEFAULT_STRING_FORMAT);
    }
