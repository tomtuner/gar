...
/**
 * Base class that represents a row from the 'banner_request' table.
 *
 * 
 *
 * @package    propel.generator.orm.om
 */
abstract class BaseBannerRequest extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ORMModel\\BannerRequestPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        BannerRequestPeer
	 */
	...
	/**
	 * The value for the banner_width field.
	 * @var        int
	 */
	protected $banner_width;

	/**
	 * The value for the banner_length field.
	 * @var        int
	 */
	protected $banner_length;
	...
	/**
	 * Get the [banner_width] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [banner_length] column value.
	 * 
	 * @return     int
	 */
	public function getBannerLength()
	{
		return $this->banner_length;
	}
	 ...
	 * @return     BannerRequest The current object (for fluent API support)
	 */
	public function setBannerRequestId($v)
	{
		...
		if ($this->banner_request_id !== $v) {
			...
			$this->modifiedColumns[] = BannerRequestPeer::BANNER_REQUEST_ID;
		}
	...
	public function setArtRequestId($v)
	{
		...
		if ($this->art_request_id !== $v) {
			...
			$this->modifiedColumns[] = BannerRequestPeer::ART_REQUEST_ID;
		}
	...
	/**
	 * Set the value of [banner_width] column.
	 * 
	 * @param      int $v new value
	 * @return     BannerRequest The current object (for fluent API support)
	 */
	public function setBannerWidth($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->banner_width !== $v) {
			$this->banner_width = $v;
			$this->modifiedColumns[] = BannerRequestPeer::BANNER_WIDTH;
		}
	...
	/**
	 * Set the value of [banner_length] column.
	 * 
	 * @param      int $v new value
	 * @return     BannerRequest The current object (for fluent API support)
	 */
	public function setBannerLength($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->banner_length !== $v) {
			$this->banner_length = $v;
			$this->modifiedColumns[] = BannerRequestPeer::BANNER_LENGTH;
		}
	...
	public function setBannerLocationId($v)
	{
		...
		if ($this->banner_location_id !== $v) {
			...
			$this->modifiedColumns[] = BannerRequestPeer::BANNER_LOCATION_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->banner_width = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->banner_length = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->banner_location_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = BannerRequestPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating BannerRequest object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = BannerRequestPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = BannerRequestQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				BannerRequestPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(BannerRequestPeer::BANNER_REQUEST_ID)) {
			$modifiedColumns[':p' . $index++]  = '`BANNER_REQUEST_ID`';
		}
		if ($this->isColumnModified(BannerRequestPeer::ART_REQUEST_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ART_REQUEST_ID`';
		}
		if ($this->isColumnModified(BannerRequestPeer::BANNER_WIDTH)) {
			$modifiedColumns[':p' . $index++]  = '`BANNER_WIDTH`';
		}
		if ($this->isColumnModified(BannerRequestPeer::BANNER_LENGTH)) {
			$modifiedColumns[':p' . $index++]  = '`BANNER_LENGTH`';
		}
		if ($this->isColumnModified(BannerRequestPeer::BANNER_LOCATION_ID)) {
			$modifiedColumns[':p' . $index++]  = '`BANNER_LOCATION_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `banner_request` (%s) VALUES (%s)',
			...
			foreach ($modifiedColumns as $identifier => $columnName) {
				switch ($columnName) {
					...
					case '`ART_REQUEST_ID`':
						...
						break;
					case '`BANNER_WIDTH`':
						$stmt->bindValue($identifier, $this->banner_width, PDO::PARAM_INT);
						break;
					case '`BANNER_LENGTH`':
						$stmt->bindValue($identifier, $this->banner_length, PDO::PARAM_INT);
						break;
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = BannerRequestPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = BannerRequestPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getBannerWidth();
				break;
			case 3:
				return $this->getBannerLength();
				break;
			case 4:
	...
	{
		if (isset($alreadyDumpedObjects['BannerRequest'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['BannerRequest'][$this->getPrimaryKey()] = true;
		$keys = BannerRequestPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getBannerRequestId(),
			$keys[1] => $this->getArtRequestId(),
			$keys[2] => $this->getBannerWidth(),
			$keys[3] => $this->getBannerLength(),
			$keys[4] => $this->getBannerLocationId(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setBannerWidth($value);
				break;
			case 3:
				$this->setBannerLength($value);
				break;
			case 4:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setBannerWidth($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setBannerLength($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setBannerLocationId($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BannerRequestPeer::BANNER_REQUEST_ID)) $criteria->add(BannerRequestPeer::BANNER_REQUEST_ID, $this->banner_request_id);
		if ($this->isColumnModified(BannerRequestPeer::ART_REQUEST_ID)) $criteria->add(BannerRequestPeer::ART_REQUEST_ID, $this->art_request_id);
		if ($this->isColumnModified(BannerRequestPeer::BANNER_WIDTH)) $criteria->add(BannerRequestPeer::BANNER_WIDTH, $this->banner_width);
		if ($this->isColumnModified(BannerRequestPeer::BANNER_LENGTH)) $criteria->add(BannerRequestPeer::BANNER_LENGTH, $this->banner_length);
		if ($this->isColumnModified(BannerRequestPeer::BANNER_LOCATION_ID)) $criteria->add(BannerRequestPeer::BANNER_LOCATION_ID, $this->banner_location_id);
	...
	{
		$criteria = new Criteria(BannerRequestPeer::DATABASE_NAME);
		$criteria->add(BannerRequestPeer::BANNER_REQUEST_ID, $this->banner_request_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of BannerRequest (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setBannerWidth($this->getBannerWidth());
		$copyObj->setBannerLength($this->getBannerLength());
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     BannerRequest Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     BannerRequestPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new BannerRequestPeer();
		}
		return self::$peer;
	}
	...
	public function getBannerLocation(PropelPDO $con = null)
	{
		if ($this->aBannerLocation === null && ($this->banner_location_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aBannerLocation->addBannerRequests($this);
			 */
		}
	...
	public function getArtRequest(PropelPDO $con = null)
	{
		if ($this->aArtRequest === null && ($this->art_request_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aArtRequest->addBannerRequests($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(BannerRequestPeer::DEFAULT_STRING_FORMAT);
	}
