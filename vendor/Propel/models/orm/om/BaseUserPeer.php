...
abstract class BaseUserPeer {
	...
	const USER_FIRST_NAME = 'user.USER_FIRST_NAME';

	/** the column name for the USER_LAST_NAME field */
	const USER_LAST_NAME = 'user.USER_LAST_NAME';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'UserFirstName', 'UserLastName', 'UserDceName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'userFirstName', 'userLastName', 'userDceName', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::USER_FIRST_NAME, self::USER_LAST_NAME, self::USER_DCE_NAME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'USER_FIRST_NAME', 'USER_LAST_NAME', 'USER_DCE_NAME', ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'user_first_name', 'user_last_name', 'user_dce_name', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'UserFirstName' => 1, 'UserLastName' => 2, 'UserDceName' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'userFirstName' => 1, 'userLastName' => 2, 'userDceName' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::USER_FIRST_NAME => 1, self::USER_LAST_NAME => 2, self::USER_DCE_NAME => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'USER_FIRST_NAME' => 1, 'USER_LAST_NAME' => 2, 'USER_DCE_NAME' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'user_first_name' => 1, 'user_last_name' => 2, 'user_dce_name' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UserPeer::USER_FIRST_NAME);
			$criteria->addSelectColumn(UserPeer::USER_LAST_NAME);
			$criteria->addSelectColumn(UserPeer::USER_DCE_NAME);
		} else {
			$criteria->addSelectColumn($alias . '.USER_ID');
			$criteria->addSelectColumn($alias . '.USER_FIRST_NAME');
			$criteria->addSelectColumn($alias . '.USER_LAST_NAME');
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(ArtRequestArtStatusPeer::USER_ID, $obj->getUserId());
