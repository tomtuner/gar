...
use ORMModel\map\EventTableMap;
...
abstract class BaseEventPeer {
	...
	const OM_CLASS = 'ORMModel\\Event';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'orm.Event';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('EventId', 'EventName', 'EventDescription', 'EventLocation', 'EventSponsorName', 'EventStartTime', 'EventEndTime', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('eventId', 'eventName', 'eventDescription', 'eventLocation', 'eventSponsorName', 'eventStartTime', 'eventEndTime', ),
		BasePeer::TYPE_COLNAME => array (self::EVENT_ID, self::EVENT_NAME, self::EVENT_DESCRIPTION, self::EVENT_LOCATION, self::EVENT_SPONSOR_NAME, self::EVENT_START_TIME, self::EVENT_END_TIME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('EVENT_ID', 'EVENT_NAME', 'EVENT_DESCRIPTION', 'EVENT_LOCATION', 'EVENT_SPONSOR_NAME', 'EVENT_START_TIME', 'EVENT_END_TIME', ),
		BasePeer::TYPE_FIELDNAME => array ('event_id', 'event_name', 'event_description', 'event_location', 'event_sponsor_name', 'event_start_time', 'event_end_time', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('EventId' => 0, 'EventName' => 1, 'EventDescription' => 2, 'EventLocation' => 3, 'EventSponsorName' => 4, 'EventStartTime' => 5, 'EventEndTime' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('eventId' => 0, 'eventName' => 1, 'eventDescription' => 2, 'eventLocation' => 3, 'eventSponsorName' => 4, 'eventStartTime' => 5, 'eventEndTime' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::EVENT_ID => 0, self::EVENT_NAME => 1, self::EVENT_DESCRIPTION => 2, self::EVENT_LOCATION => 3, self::EVENT_SPONSOR_NAME => 4, self::EVENT_START_TIME => 5, self::EVENT_END_TIME => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('EVENT_ID' => 0, 'EVENT_NAME' => 1, 'EVENT_DESCRIPTION' => 2, 'EVENT_LOCATION' => 3, 'EVENT_SPONSOR_NAME' => 4, 'EVENT_START_TIME' => 5, 'EVENT_END_TIME' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('event_id' => 0, 'event_name' => 1, 'event_description' => 2, 'event_location' => 3, 'event_sponsor_name' => 4, 'event_start_time' => 5, 'event_end_time' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(EventPricePeer::EVENT_ID, $obj->getEventId());
