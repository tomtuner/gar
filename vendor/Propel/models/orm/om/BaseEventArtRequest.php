...
/**
 * Base class that represents a row from the 'event_art_request' table.
 *
 * 
 *
 * @package    propel.generator.orm.om
 */
abstract class BaseEventArtRequest extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ORMModel\\EventArtRequestPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        EventArtRequestPeer
	 */
	 ...
	 * @return     EventArtRequest The current object (for fluent API support)
	 */
	public function setEventId($v)
	{
		...
		if ($this->event_id !== $v) {
			$this->event_id = $v;
			$this->modifiedColumns[] = EventArtRequestPeer::EVENT_ID;
		}
	...
	public function setArtRequestId($v)
	{
		...
		if ($this->art_request_id !== $v) {
			...
			$this->modifiedColumns[] = EventArtRequestPeer::ART_REQUEST_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = EventArtRequestPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating EventArtRequest object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EventArtRequestPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = EventArtRequestQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				EventArtRequestPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(EventArtRequestPeer::EVENT_ID)) {
			$modifiedColumns[':p' . $index++]  = '`EVENT_ID`';
		}
		if ($this->isColumnModified(EventArtRequestPeer::ART_REQUEST_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ART_REQUEST_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `event_art_request` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EventArtRequestPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EventArtRequestPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['EventArtRequest'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['EventArtRequest'][serialize($this->getPrimaryKey())] = true;
		$keys = EventArtRequestPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventArtRequestPeer::EVENT_ID)) $criteria->add(EventArtRequestPeer::EVENT_ID, $this->event_id);
		if ($this->isColumnModified(EventArtRequestPeer::ART_REQUEST_ID)) $criteria->add(EventArtRequestPeer::ART_REQUEST_ID, $this->art_request_id);
	...
	{
		$criteria = new Criteria(EventArtRequestPeer::DATABASE_NAME);
		$criteria->add(EventArtRequestPeer::EVENT_ID, $this->event_id);
		$criteria->add(EventArtRequestPeer::ART_REQUEST_ID, $this->art_request_id);
	...
	{
		return (null === $this->getEventId()) && (null === $this->getArtRequestId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EventArtRequest (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EventArtRequest Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EventArtRequestPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EventArtRequestPeer();
		}
		return self::$peer;
	}
	...
	public function getArtRequest(PropelPDO $con = null)
	{
		if ($this->aArtRequest === null && ($this->art_request_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aArtRequest->addEventArtRequests($this);
			 */
		}
	...
	public function getEvent(PropelPDO $con = null)
	{
		if ($this->aEvent === null && ($this->event_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aEvent->addEventArtRequests($this);
			 */
		}
		return $this->aEvent;
	}
	...
	{
		return (string) $this->exportTo(EventArtRequestPeer::DEFAULT_STRING_FORMAT);
	}
